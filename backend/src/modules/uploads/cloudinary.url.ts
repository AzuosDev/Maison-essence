 ...
 *
 * Função pura, sem nada do Nest, de propósito: o frontend usa exatamente esta
 * regra para montar `src` e `srcset`, e as duas pontas precisam concordar.
 * Se divergirem, o navegador baixa uma variante que ninguém mais pede e o
 ...
 *   decidindo pelo `Accept` do navegador — e o que corta o peso da página
 *   sem guardar várias copias da foto;
...
/** As três URLs de uma vez, do jeito que a resposta da API as entrega. */
