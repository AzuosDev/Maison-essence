...
/** Endereco salvo, como a loja o exibe. */
...
/**
 * A conta como quem comprou a ve.
 *
 * Montada campo a campo, e nao devolvendo o documento: e o que garante que
...
/** Sessao da loja. Mesmo formato do painel, sem nada que lembre papel. */
