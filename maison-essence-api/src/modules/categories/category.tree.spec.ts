...
describe('branchesOf', () => {
  ...
  it('desempata pelo nome, para a lista nao dancar entre duas chamadas', () => {
  ...
  it('deixa de fora o filho cujo pai nao veio na lista', () => {
    ...
    const arabes = category('Arabes', 0, ausente);
