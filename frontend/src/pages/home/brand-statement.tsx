 ...
 *
 * O texto e fixo, e nao vem do painel. E a mesma regra dos selos de
 * confianca: isto e uma afirmacao sobre como a loja trabalha — selecao curta,
 * original, entrega combinada no WhatsApp — e nao um campo que se ajusta de
 * um dia para o outro. Quando deixar de ser verdade, muda aqui, com revisao.
 *
 * O link leva a pagina "Quem somos", que ai sim a dona escreve pelo painel:
 * este bloco e a chamada, e a pagina e o texto inteiro.
 */
