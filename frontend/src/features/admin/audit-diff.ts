...
const ACTION_LABELS: Record<string, string> = {
  ...
  [AUDIT_ACTIONS.USER_CREATED]: 'Criou um usuario',
  [AUDIT_ACTIONS.USER_UPDATED]: 'Editou um usuario',
  [AUDIT_ACTIONS.USER_ACTIVATED]: 'Ativou um usuario',
  [AUDIT_ACTIONS.USER_DEACTIVATED]: 'Desativou um usuario',
  [AUDIT_ACTIONS.USER_PASSWORD_RESET]: 'Resetou uma senha',
  [AUDIT_ACTIONS.USER_PASSWORD_CHANGED]: 'Trocou a propria senha',
  [AUDIT_ACTIONS.SETTINGS_UPDATED]: 'Mudou as configuracoes da loja',
  [AUDIT_ACTIONS.PAYMENT_SETTINGS_UPDATED]: 'Mudou as condicoes de pagamento',
  [AUDIT_ACTIONS.PRODUCT_PRICE_CHANGED]: 'Mudou o preco de um produto',
...
const FIELD_LABELS: Record<string, string> = {
  ...
  priceCents: 'Preco',
  compareAtPriceCents: 'Preco de comparacao',
